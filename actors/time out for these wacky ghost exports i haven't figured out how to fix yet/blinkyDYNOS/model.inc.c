...
Lights1 mario_blinkyshirt_lights = gdSPDefLights1(
	0x7F, 0x0, 0xD,
	0xFF, 0x0, 0x25, 0x28, 0x28, 0x28);
...
Vtx mario_Left_Arm_Color_mesh_layer_1_vtx_0[11] = {
	{{{50, 0, 29}, 0, {68, 137}, {0xED, 0x00, 0x7E, 0xFF}}},
	{{{0, 0, 23}, 0, {68, 137}, {0xC3, 0x00, 0x6F, 0xFF}}},
	{{{0, -22, 7}, 0, {68, 137}, {0xC3, 0x96, 0x22, 0xFF}}},
	{{{50, 28, 9}, 0, {68, 137}, {0xED, 0x77, 0x27, 0xFF}}},
	{{{0, 22, 7}, 0, {68, 137}, {0xC3, 0x6A, 0x22, 0xFF}}},
	{{{50, 17, -24}, 0, {68, 137}, {0xED, 0x4A, 0x9A, 0xFF}}},
	{{{0, 14, -19}, 0, {68, 137}, {0xC3, 0x41, 0xA6, 0xFF}}},
	{{{50, -17, -24}, 0, {68, 137}, {0xED, 0xB6, 0x9A, 0xFF}}},
	{{{0, -14, -19}, 0, {68, 137}, {0xC3, 0xBF, 0xA6, 0xFF}}},
	{{{50, -28, 9}, 0, {68, 137}, {0xED, 0x89, 0x27, 0xFF}}},
	{{{-14, 0, 0}, 0, {68, 137}, {0x81, 0x00, 0x00, 0xFF}}},
};
...
Vtx mario_Left_Forearm_mesh_layer_1_vtx_0[5] = {
	{{{16, 34, 11}, 0, {68, 137}, {0xEA, 0x77, 0x27, 0xFF}}},
	{{{16, 0, 35}, 0, {68, 137}, {0xEA, 0x00, 0x7D, 0xFF}}},
	{{{16, 21, -29}, 0, {68, 137}, {0xEA, 0x4A, 0x9B, 0xFF}}},
	{{{16, -21, -29}, 0, {68, 137}, {0xEA, 0xB6, 0x9B, 0xFF}}},
	{{{16, -34, 11}, 0, {68, 137}, {0xEA, 0x89, 0x27, 0xFF}}},
};
...
Vtx mario_Right_Arm_Color_mesh_layer_1_vtx_0[11] = {
	{{{50, 0, -28}, 0, {68, 137}, {0xED, 0x00, 0x82, 0xFF}}},
	{{{0, -22, -6}, 0, {68, 137}, {0xC3, 0x96, 0xDE, 0xFF}}},
	{{{0, 0, -22}, 0, {68, 137}, {0xC3, 0x00, 0x91, 0xFF}}},
	{{{50, -28, -8}, 0, {68, 137}, {0xED, 0x89, 0xD9, 0xFF}}},
	{{{0, -14, 20}, 0, {68, 137}, {0xC3, 0xBF, 0x5A, 0xFF}}},
	{{{50, -17, 25}, 0, {68, 137}, {0xED, 0xB6, 0x66, 0xFF}}},
	{{{0, 14, 20}, 0, {68, 137}, {0xC3, 0x41, 0x5A, 0xFF}}},
	{{{50, 17, 25}, 0, {68, 137}, {0xED, 0x4A, 0x66, 0xFF}}},
	{{{0, 22, -6}, 0, {68, 137}, {0xC3, 0x6A, 0xDE, 0xFF}}},
	{{{50, 28, -8}, 0, {68, 137}, {0xED, 0x77, 0xD9, 0xFF}}},
	{{{-14, 0, 1}, 0, {68, 137}, {0x81, 0x00, 0x00, 0xFF}}},
};
...
Vtx mario_Right_Forearm_mesh_layer_1_vtx_0[5] = {
	{{{16, 34, -10}, 0, {68, 137}, {0xEA, 0x77, 0xD9, 0xFF}}},
	{{{16, 0, -34}, 0, {68, 137}, {0xEA, 0x00, 0x83, 0xFF}}},
	{{{16, -34, -10}, 0, {68, 137}, {0xEA, 0x89, 0xD9, 0xFF}}},
	{{{16, -21, 30}, 0, {68, 137}, {0xEA, 0xB6, 0x65, 0xFF}}},
	{{{16, 21, 30}, 0, {68, 137}, {0xEA, 0x4A, 0x65, 0xFF}}},
};
...
Gfx mat_revert_mario_blinkyshirt[] = {
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetTextureLUT(G_TT_NONE),
	gsSPEndDisplayList(),
...
Gfx mario_Head_DL_skinned_mesh_layer_1_mat_override_ghostblue_4[] = {
	gsSPDisplayList(mat_mario_ghostblue),
	gsSPDisplayList(mario_Head_DL_skinned_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_mario_ghostblue),
	gsSPEndDisplayList(),
...
Gfx mario_Head_DL_mesh_layer_1_mat_override_ghostblue_4[] = {
	gsSPDisplayList(mat_mario_ghostblue),
	gsSPDisplayList(mario_Head_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mario_Head_DL_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_revert_mario_ghostblue),
...
Gfx mario_Left_Arm_Color_mesh_layer_1[] = {
	gsSPDisplayList(mat_mario_blinkyshirt),
	gsSPDisplayList(mario_Left_Arm_Color_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_mario_blinkyshirt),
	gsSPEndDisplayList(),
};
